...
ffnn_model = LanguageDetector_FFNN(390, 7)
ffnn_trainer = ModelTrainer(ffnn_model,device)
optimizer = optim.Adam(ffnn_model.parameters(), lr=0.0005)

history = ffnn_trainer.train(200, inputs, labels, optimizer, nn.CrossEntropyLoss(), validation_data=(x_val,y_val), batch_size=512)